...
public class ManageController {
	...
	public PageResult  findPage(int page,int rows){			
		return manageService.findPage(page, rows);
	}
	 ...
	 */
	@RequestMapping("/add")
	public Result add(@RequestBody TbManage manage){
		try {
	...
	public Result update(@RequestBody TbManage manage){
		try {
	...
	public TbManage findOne(Integer id){
		return manageService.findOne(id);		
	}
	...
	public PageResult search(@RequestBody TbManage manage, int page, int rows  ){
		return manageService.findPage(manage, page, rows);		
	}
